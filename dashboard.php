          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                <div class="inner">
                  <h3><?php include 'counters/occ-building.php' ?></h3>

                  <p>Occupied Buildings</p>
                </div>
                <div class="icon">
                  <i class="ion ion-pie-graph"></i>
                </div>
                <a href="manage-building.php" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-red">
                <div class="inner">
                  <h3><?php include 'counters/av-building.php' ?></h3>

                  <p>Available Building</p>
                </div>
                <div class="icon">
