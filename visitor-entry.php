<?php
    ...
    $query=mysqli_query($con,"INSERT into tblvisitor(VisitorName, MobileNumber, Address, Gender, Building, BuildingNo, WhomtoMeet, Reason) value('$visname','$contactnumber','$address','$gender','$building', '$buildingno', '$whomtomeet', '$reason')");
          ...
          <!-- /.box-header -->
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label>Building</label>
                        <select class="form-control select2" name="building" onChange="getBuilding(this.value);" style="width: 100%;" required>
                        <option selected="">Choose....</option>
                        <?php $query=mysqli_query($con,"SELECT * from building");
                ...
                <div class="form-group">
                    <label>Office</label>
                    <select class="form-control select2" name="buildingno" onChange="getBuilding(this.value);" style="width: 100%;" required>
                        <option selected="">Choose....</option>
                        <?php $query=mysqli_query($con,"SELECT * from building");
                            while($row=mysqli_fetch_array($query)){?>    
