  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Current Visitors</li>
      </ol>
    </section>
      <hr class="mb-0">
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">List of Current Visitors</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover table-striped">
                ...
                <tr>
                  ...
                  <td class='text-center'><a href="action-visitor.php?editid=<?php echo $row['ID'];?>" title="View Full Details"><i class="fa fa-edit" style="color:green;"></i> Update</a></td>
