 ...
 <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php if($page=='building') { echo 'active'; }?>">
          <a href="manage-building.php">
            <i class="fa fa-building-o"></i> <span>Building List</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
        ...
        <li class="<?php if($page=='equipment') { echo 'active'; }?>">
          <a href="equipment.php">
            <i class="fa fa-plus"></i> <span> Add Equipment</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>

        <li class="<?php if($page=='manage-equipment') { echo 'active'; }?>">
          <a href="manage-equipment.php">
            <i class="fa fa-plus"></i> <span>Manage Equipment</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
